 ...
 */
public class ConsumptionTable implements BaseColumns {
    public static final String TABLE_NAME = "consumption_table";
    ...
    public static final int CONSUMPTIONS = 1;

    public static final UriMatcher URIMatcher = new UriMatcher(UriMatcher.NO_MATCH);
    public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.kase.consumption";

    static {
        URIMatcher.addURI(Database.AUTHORITY, TABLE_NAME, CONSUMPTIONS);
    }

    /**
     * Creates consumption table
     *
